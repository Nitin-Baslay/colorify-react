...
const Login = () => {
  ...
  const signUpHandler = () => {
    axios
      .post(
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAFIn174YoVA_ha5RGrDR6MmD3Oxh0L8iU",
  ...
  const signInHandler = () => {
    axios
      .post(
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAFIn174YoVA_ha5RGrDR6MmD3Oxh0L8iU",
        { email: email, password: password, returnSecureToken: true }
      )
      .then((response) => {
