...
const Home = () => {
  ...
  const addColorHandler = () => {
    ...
    axios.post(
      `https://colorify-676d0-default-rtdb.firebaseio.com/name/${Id}.json`,
      colorObj
    );
  };
  axios
    .get(`https://colorify-676d0-default-rtdb.firebaseio.com/name/${Id}.json`)
    .then((response) => {
      let Colors = [];
  ...
  const editHandler = (key) => {
    ...
    axios.put(
      `https://colorify-676d0-default-rtdb.firebaseio.com/name/${Id}/${key}.json`,
      updatedcolorObj
    );
  };
